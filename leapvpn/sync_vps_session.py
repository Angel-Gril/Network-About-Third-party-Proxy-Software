...
from export_leapvpn import decode_settings
...
def main():
    ...
    remote = "/opt/private-subscription/providers/leapvpn/venv/bin/python /opt/private-subscription/providers/leapvpn/receive_vps_session.py"
    if args.no_refresh:
        remote += " --no-refresh"
