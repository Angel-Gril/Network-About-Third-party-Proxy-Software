...
from leapvpn.export import ExportError, _ApiError
from leapvpn.auth import (
...
class AuthenticationTests(unittest.TestCase):
    ...
    def test_failed_state_replace_keeps_previous_session(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch("leapvpn.auth.os.replace", side_effect=OSError("disk unavailable")):
...
class DiscoveryTests(unittest.TestCase):
    ...
    @patch("leapvpn.auth._api_request")
...
class RefreshTests(unittest.TestCase):
    def test_binding_failure_preserves_registered_identity_for_next_run(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch("leapvpn.auth.ApiClient") as client:
