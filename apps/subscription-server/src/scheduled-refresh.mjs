...
export function isMainModule(argvPath, moduleUrl = import.meta.url, resolvePath = realpathSync,
  urlToPath = fileURLToPath) {
  if (!argvPath) return false;
  try { return resolvePath(argvPath) === resolvePath(urlToPath(moduleUrl)); }
  catch { return false; }
}
