#!/usr/bin/env python3
"""Compatibility launcher for the local account-based PowerShell exporter."""
...
def main() -> int:
    ...
    parser.add_argument("-o", "--outdir", default="fb_export", help="输出目录")
    ...
    script = Path(__file__).with_name("export_fb_all.ps1").resolve()
    command = [
        powershell,
        "-NoProfile",
        "-ExecutionPolicy",
